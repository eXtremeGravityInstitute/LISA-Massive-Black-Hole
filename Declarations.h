...
void MCMC(struct Data *dat, struct Het *het, int ll, double *params);
void update(struct Data *dat, struct Het *het, int typ, int k, int ll, double *logLx, double **paramx, double **paramy, double *min, double *max, int *who, double *heat, double ***history, int NH, double **ejump, double ***evec, int **cv, int **av, gsl_rng *r);
double Likelihood(struct Data *dat, int ll, double *params);
